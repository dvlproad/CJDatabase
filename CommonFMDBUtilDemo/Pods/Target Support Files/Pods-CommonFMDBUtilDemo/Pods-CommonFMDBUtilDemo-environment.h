...
// FMDBHelper
#define COCOAPODS_POD_AVAILABLE_FMDBHelper
#define COCOAPODS_VERSION_MAJOR_FMDBHelper 0
#define COCOAPODS_VERSION_MINOR_FMDBHelper 0
#define COCOAPODS_VERSION_PATCH_FMDBHelper 8
